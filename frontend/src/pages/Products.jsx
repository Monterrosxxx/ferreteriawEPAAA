...
const Products = ({ onLogOut, onNavigateToBrands, onNavigateToProviders, userInfo }) => {
    ...
    const handleEditProduct = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://ferreteriaepa-1vms.onrender.com/api/products/${editingProduct._id}`, {
                method: 'PUT',
                body: forDataToSend,
            });
    ...
    const handleDeleteProduct = async (productId) => {
        try {
            const response = await fetch(`https://ferreteriaepa-1vms.onrender.com/api/products/${productId}`, {
                method: 'DELETE',
            });
