...
const Products = ({ onLogOut, onNavigateToBrands, onNavigateToProviders, userInfo }) => {
    ...
    const fetchProducts = async () => {
        try {
            setLoading(true);
            const response = await fetch('https://ferreteriawepaaa.onrender.com/api/products');
            if (!response.ok) {
    ...
    const handleEditProduct = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://ferreteriawepaaa.onrender.com/api/products/${editingProduct._id}`, {
                method: 'PUT',
                body: forDataToSend,
            });
    ...
    const handleDeleteProduct = async (productId) => {
        try {
            const response = await fetch(`https://ferreteriawepaaa.onrender.com/api/products/${productId}`, {
                method: 'DELETE',
            });
